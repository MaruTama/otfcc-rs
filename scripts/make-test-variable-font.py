...
# `instances` array (FvarInstanceList/FvarInstance/VV in src/table/
# fvar.rs and src/vf/{vv,vq}.rs) is exercised too -- without them the
...
# untested by compare-with-c.sh/tests/cycles.rs.
