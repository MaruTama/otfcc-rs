...
pub static FS_TYPE_LABELS: [&str; 10] = [
    "_reserved1",
    "restrictedLicense",
    "previewPrintLicense",
    "editableEmbedding",
...
pub static FS_SELECTION_LABELS: [&str; 10] = [
    "italic",
    "underscore",
    "negative",
    "outlined",
...
pub static CODE_PAGE_LABELS1: [&str; 32] = [
    "latin1",
    "latin2",
    "cyrillic",
    "greek",
...
pub static CODE_PAGE_LABELS2: [&str; 32] = [
    "oem8", "oem9", "oem10", "oem11", "oem12", "oem13", "oem14", "oem15", "oem16",
    "oem17", "oem18", "oem19", "oem20", "oem21", "oem22", "oem23", "cp869", "cp866",
    "cp865", "cp864", "cp863", "cp862", "cp861", "cp860", "cp857", "cp855", "cp852",
    "cp775", "cp737", "cp708", "cp850", "ascii",
];
pub static UNICODE_RANGE_LABELS1: [&str; 32] = [
    "Basic_Latin",
    "Latin_1_Supplement",
    "Latin_Extended_A",
    "Latin_Extended_B",
...
pub static UNICODE_RANGE_LABELS2: [&str; 32] = [
...
pub static UNICODE_RANGE_LABELS3: [&str; 32] = [
...
pub static UNICODE_RANGE_LABELS4: [&str; 27] = [
    "Buginese",
    "Glagolitic",
    "Tifinagh",
