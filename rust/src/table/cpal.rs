...
pub struct CpalColorElementInterface {
    ...
    pub copy_replace: Option<unsafe extern "C" fn(*mut CpalColor, CpalColor) -> ()>,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
pub struct CpalColorSetVectorInterface {
    ...
    pub copy_replace: Option<unsafe extern "C" fn(*mut CpalColorSet, CpalColorSet) -> ()>,
    pub create: Option<unsafe extern "C" fn() -> *mut CpalColorSet>,
    pub free: Option<unsafe extern "C" fn(*mut CpalColorSet) -> ()>,
    pub init_n: Option<unsafe extern "C" fn(*mut CpalColorSet, usize) -> ()>,
    pub init_cap_n: Option<unsafe extern "C" fn(*mut CpalColorSet, usize) -> ()>,
    pub create_n: Option<unsafe extern "C" fn(usize) -> *mut CpalColorSet>,
    ...
    pub shrink_to_fit: Option<unsafe extern "C" fn(*mut CpalColorSet) -> ()>,
    pub pop: Option<unsafe extern "C" fn(*mut CpalColorSet) -> CpalColor>,
    pub dispose_item: Option<unsafe extern "C" fn(*mut CpalColorSet, usize) -> ()>,
...
pub struct CpalPaletteElementInterface {
    ...
    pub copy_replace: Option<unsafe extern "C" fn(*mut CpalPalette, CpalPalette) -> ()>,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
pub struct CpalPaletteSetVectorInterface {
    ...
    pub copy_replace: Option<unsafe extern "C" fn(*mut CpalPaletteSet, CpalPaletteSet) -> ()>,
    pub create: Option<unsafe extern "C" fn() -> *mut CpalPaletteSet>,
    pub free: Option<unsafe extern "C" fn(*mut CpalPaletteSet) -> ()>,
    pub init_n: Option<unsafe extern "C" fn(*mut CpalPaletteSet, usize) -> ()>,
    pub init_cap_n: Option<unsafe extern "C" fn(*mut CpalPaletteSet, usize) -> ()>,
    pub create_n: Option<unsafe extern "C" fn(usize) -> *mut CpalPaletteSet>,
    ...
    pub shrink_to_fit: Option<unsafe extern "C" fn(*mut CpalPaletteSet) -> ()>,
    pub pop: Option<unsafe extern "C" fn(*mut CpalPaletteSet) -> CpalPalette>,
    pub dispose_item: Option<unsafe extern "C" fn(*mut CpalPaletteSet, usize) -> ()>,
    pub filter_env: Option<
        unsafe extern "C" fn(
            *mut CpalPaletteSet,
...
pub struct CpalTableElementInterface {
    ...
    pub copy_replace: Option<unsafe extern "C" fn(*mut CpalTable, CpalTable) -> ()>,
...
unsafe extern "C" fn cpal_color_set_copy(
    ...
    if CPAL_I_COLOR.copy.is_some() {
        ...
        while j < (*src).length {
            CPAL_I_COLOR.copy.expect("non-null function pointer")(
...
unsafe extern "C" fn cpal_color_set_fill(mut arr: *mut CpalColorSet, mut n: usize) {
    while (*arr).length < n {
        ...
        if CPAL_I_COLOR.init.is_some() {
            CPAL_I_COLOR.init.expect("non-null function pointer")(&raw mut x);
        } else {
            memset(
...
pub static CPAL_I_COLOR_SET: CpalColorSetVectorInterface = {
    CpalColorSetVectorInterface {
        ...
        init_n: Some(cpal_color_set_init_n as unsafe extern "C" fn(*mut CpalColorSet, usize) -> ()),
        init_cap_n: Some(
            cpal_color_set_init_cap_n as unsafe extern "C" fn(*mut CpalColorSet, usize) -> (),
        ),
        create_n: Some(cpal_color_set_create_n as unsafe extern "C" fn(usize) -> *mut CpalColorSet),
...
unsafe extern "C" fn cpal_palette_set_fill(mut arr: *mut CpalPaletteSet, mut n: usize) {
    while (*arr).length < n {
        ...
        if CPAL_I_PALETTE.init.is_some() {
            CPAL_I_PALETTE.init.expect("non-null function pointer")(&raw mut x);
        } else {
            memset(
                &raw mut x as *mut ::core::ffi::c_void,
                0 as ::core::ffi::c_int,
...
unsafe extern "C" fn cpal_palette_set_copy(
    ...
    if CPAL_I_PALETTE.copy.is_some() {
        let mut j: usize = 0 as usize;
        while j < (*src).length {
            CPAL_I_PALETTE.copy.expect("non-null function pointer")(
        ...
        while __fortable_keep != 0 {
            if table.tag == 1129333068i32 as u32 {
                ...
                while __fortable_k2 != 0 {
                    ...
                    if !(length < 2 as u32) {
                        t = (
                            TABLE_I_CPAL.create.expect("non-null function pointer"))();
                                    ...
                                    ))
                                {
                                        ...
                                        < num_color_records as ::core::ffi::c_int
                                    {
                                        *color_list.offset(j as isize) = CpalColor {
                                            ...
                                            blue: read_8u(
                                                data.offset(offset_first_color_record as isize).offset(
                                                    (j as ::core::ffi::c_int
                                                        * 4 as ::core::ffi::c_int)
                                                        as isize,
                                                )
                                        ...
                                        < num_palettes as ::core::ffi::c_int
                                    {
                                        ...
                                        CPAL_I_PALETTE.init.expect("non-null function pointer")(
                                            &raw mut palette,
                                        );
                                        ...
                                        CPAL_I_PALETTE_SET.push.expect("non-null function pointer")(
                                            &raw mut (*t).palettes,
                                            palette,
                                        );
                                        j_0 = j_0.wrapping_add(1);
                                    ...
                                    if version as ::core::ffi::c_int > 0 as ::core::ffi::c_int {
                                        ...
                                        if version as ::core::ffi::c_int > 0 as ::core::ffi::c_int {
                                            ...
                                            if offset_palette_entry_label_array != 0
                                                && length
                                                    >= offset_palette_entry_label_array.wrapping_add(
                                                        (4 as ::core::ffi::c_int
                                                    ...
                                                    )
                                            {
                                                    ...
                                                    < num_palettes_entries as ::core::ffi::c_int
                                                {
                                                    let mut label_0: u16 = read_16u(
                                                        ...
                                                        .offset(
                                                            offset_palette_entry_label_array as isize,
                                                        )
                                                            as *const u8,
                                                    );
                    ...
                    TABLE_I_CPAL.free.expect("non-null function pointer")(t);
        ...
        while (j as ::core::ffi::c_uint) < (*_palettes).u.array.length {
                ...
                || (*_palette).type_0 != JsonType::Object)
            {
                ...
                if !_colors.is_null() {
                    ...
                    CPAL_I_PALETTE.init.expect("non-null function pointer")(&raw mut palette);
...
pub unsafe extern "C" fn otfcc_build_cpal(
    ...
    let mut num_palettes: u16 = (*cpal).palettes.length as u16;
    let mut num_palettes_entries: u16 = (*(*cpal)
        .palettes
        .items
        .offset(0 as ::core::ffi::c_int as isize))
    .colorset
    ...
    while (j as ::core::ffi::c_int) < num_palettes as ::core::ffi::c_int {
        ...
        let mut total_colors: ColorId = (*palette).colorset.length as ColorId;
        let mut k: ColorId = 0 as ColorId;
        while (k as ::core::ffi::c_int) < num_palettes_entries as ::core::ffi::c_int {
            ...
            bk_push(color_records, &[bk_int(BkCellType::B8, ((*color).blue as ::core::ffi::c_int) as u32), bk_int(BkCellType::B8, ((*color).green as ::core::ffi::c_int) as u32), bk_int(BkCellType::B8, ((*color).red as ::core::ffi::c_int) as u32), bk_int(BkCellType::B8, ((*color).alpha as ::core::ffi::c_int) as u32)]);
            k = k.wrapping_add(1);
        }
        j = j.wrapping_add(1);
    }
