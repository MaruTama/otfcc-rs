...
pub const op_FDArray: C2RustUnnamed = 3108;
pub const op_UIDBase: C2RustUnnamed = 3107;
pub const op_CIDCount: C2RustUnnamed = 3106;
pub const op_CIDFontType: C2RustUnnamed = 3105;
pub const op_CIDFontRevision: C2RustUnnamed = 3104;
pub const op_CIDFontVersion: C2RustUnnamed = 3103;
pub const op_ROS: C2RustUnnamed = 3102;
pub const op_maxstack: C2RustUnnamed = 25;
pub const op_vstore: C2RustUnnamed = 24;
pub const op_BaseFontBlend: C2RustUnnamed = 3095;
pub const op_blend: C2RustUnnamed = 23;
pub const op_BaseFontName: C2RustUnnamed = 3094;
pub const op_vsindex: C2RustUnnamed = 22;
pub const op_PostScript: C2RustUnnamed = 3093;
pub const op_nominalWidthX: C2RustUnnamed = 21;
pub const op_SyntheicBase: C2RustUnnamed = 3092;
pub const op_defaultWidthX: C2RustUnnamed = 20;
pub const op_initialRandomSeed: C2RustUnnamed = 3091;
pub const op_Subrs: C2RustUnnamed = 19;
pub const op_ExpansionFactor: C2RustUnnamed = 3090;
pub const op_Private: C2RustUnnamed = 18;
pub const op_LanguageGroup: C2RustUnnamed = 3089;
pub const op_CharStrings: C2RustUnnamed = 17;
pub const op_Encoding: C2RustUnnamed = 16;
pub const op_charset: C2RustUnnamed = 15;
pub const op_ForceBold: C2RustUnnamed = 3086;
pub const op_XUID: C2RustUnnamed = 14;
pub const op_StemSnapV: C2RustUnnamed = 3085;
pub const op_UniqueID: C2RustUnnamed = 13;
pub const op_StemSnapH: C2RustUnnamed = 3084;
pub const op_BlueFuzz: C2RustUnnamed = 3083;
pub const op_StdVW: C2RustUnnamed = 11;
pub const op_BlueShift: C2RustUnnamed = 3082;
pub const op_StdHW: C2RustUnnamed = 10;
pub const op_BlueScale: C2RustUnnamed = 3081;
pub const op_FamilyOtherBlues: C2RustUnnamed = 9;
pub const op_StrokeWidth: C2RustUnnamed = 3080;
pub const op_FamilyBlues: C2RustUnnamed = 8;
pub const op_FontMatrix: C2RustUnnamed = 3079;
pub const op_OtherBlues: C2RustUnnamed = 7;
pub const op_CharstringType: C2RustUnnamed = 3078;
pub const op_BlueValues: C2RustUnnamed = 6;
pub const op_PaintType: C2RustUnnamed = 3077;
pub const op_FontBBox: C2RustUnnamed = 5;
pub const op_UnderlineThickness: C2RustUnnamed = 3076;
pub const op_Weight: C2RustUnnamed = 4;
pub const op_UnderlinePosition: C2RustUnnamed = 3075;
pub const op_FamilyName: C2RustUnnamed = 3;
pub const op_ItalicAngle: C2RustUnnamed = 3074;
pub const op_FullName: C2RustUnnamed = 2;
pub const op_isFixedPitch: C2RustUnnamed = 3073;
pub const op_Notice: C2RustUnnamed = 1;
pub const op_Copyright: C2RustUnnamed = 3072;
pub const op_version: C2RustUnnamed = 0;
