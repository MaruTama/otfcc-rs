...
pub unsafe extern "C" fn cff_build_header() -> *mut Buffer {
    return bufninit(&[1 as u8, 0 as u8, 4 as u8, 4 as u8]);
}
pub unsafe extern "C" fn cff_merge_cs2_operator(mut blob: *mut Buffer, mut val: i32) {
    if val >= 0x100 as i32 {
...
pub unsafe extern "C" fn cff_merge_cs2_int(mut blob: *mut Buffer, mut val: i32) {
...
unsafe extern "C" fn merge_cs2_real(mut blob: *mut Buffer, mut val: ::core::ffi::c_double) {
...
pub unsafe extern "C" fn cff_merge_cs2_operand(
    mut blob: *mut Buffer,
...
pub unsafe extern "C" fn cff_merge_cs2_special(mut blob: *mut Buffer, mut val: u8) {
    bufwrite8(blob, val);
}
pub unsafe extern "C" fn cff_build_offset(mut val: i32) -> *mut Buffer {
