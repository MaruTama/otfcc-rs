...
use crate::table::otl::coverage::{shrinkCoverage, otl_Coverage};
use crate::support::handle::{handle_consolidateTo, otfcc_Handle_dispose, otfcc_Handle, otfcc_GlyphHandle, otfcc_LookupHandle, HANDLE_STATE_INDEX};
#[derive(Copy, Clone)]
#[repr(C)]
