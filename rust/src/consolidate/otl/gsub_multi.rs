...
unsafe extern "C" fn by_from_id_multi(
    mut a: *mut GsubMultiHash,
    mut b: *mut GsubMultiHash,
) -> ::core::ffi::c_int {
...
pub unsafe extern "C" fn consolidate_gsub_multi(
    ...
    while (k as usize) < (*subtable).len() {
        if !OTFCC_PKG_GLYPH_ORDER
            ...
            if (*(&(*subtable))[k as usize].to).num_glyphs == 0 {
                ...
                _hf_hashv = _hf_hashv.wrapping_sub(_hj_j);
                _hf_hashv ^= _hj_j >> 15 as ::core::ffi::c_int;
                s = ::core::ptr::null_mut::<GsubMultiHash>();
                if !h.is_null() {
                ...
                if s.is_null() {
                    s = __caryll_allocate_clean(
                        ::core::mem::size_of::<GsubMultiHash>() as usize,
        ...
        while _hs_looping != 0 as ::core::ffi::c_uint {
            ...
            if _hs_nmerges <= 1 as ::core::ffi::c_uint {
                ...
                h = (_hs_list as *mut ::core::ffi::c_char).offset(-(*(*h).hh.tbl).hho)
                    as *mut ::core::ffi::c_void as *mut GsubMultiHash
                    as *mut GsubMultiHash;
            }
    ...
    while !s_0.is_null() {
        ...
        if (*_hd_hh_del).prev.is_null() && (*_hd_hh_del).next.is_null() {
            ...
            h = ::core::ptr::null_mut::<GsubMultiHash>();
        } else {
            ...
            if !(*_hd_hh_del).prev.is_null() {
                ...
                *fresh1 = (*_hd_hh_del).next;
                ...
                h = (*_hd_hh_del).next as *mut GsubMultiHash as *mut GsubMultiHash;
            }
        ...
        s_0 = ::core::ptr::null_mut::<GsubMultiHash>();
        s_0 = tmp;
