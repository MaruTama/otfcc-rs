...
# builds) was deleted from the tree -- see rust/scripts/archive/README.md and
# the "Next steps" entry in rust/README.md for when and why. This script
...
#
# Invoke as: ./rust/scripts/archive/compare-with-c.sh (after restoring c/)
set -euo pipefail
cd "$(dirname "$0")/../../.."
